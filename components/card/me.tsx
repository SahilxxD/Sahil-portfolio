...
import myImage from "@/public/assets/images/me/1.jpg"
    ...
    return (
        <Card className="2xl:h-full">
            <div className="w-full h-[400px] sm:h-[500px] overflow-hidden">
                {/* Background Image */}
                <Image
                    src={myImage} alt={"sahil khairnar"}
            ...
            <div className="absolute top-[65%] space-y-2">
                ...
                <Tag text="I'm SAHIL KHAIRNAR" className="rounded-tr-2xl rounded-br-2xl rounded-bl-2xl" />
